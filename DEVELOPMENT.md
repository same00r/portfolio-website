...
```bash
git remote add encore encore://portfolio-website-bnvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/portfolio-website-bnvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/portfolio-website-bnvi/settings/integrations/github)
